...
export default function DeleteConfirmModal({ isOpen, animal, onClose, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-[#D4A574]/30 animate-in fade-in zoom-in duration-200 p-6 text-center">
        ...
        <h2 className="text-2xl font-bold text-[#4A2C17] mb-2">Delete Listing?</h2>
        <p className="text-[#6B3E26] mb-8">
          Are you sure you want to delete <span className="font-bold">{animal.petName}</span>? This action cannot be undone.
        </p>

    ...
    <div className="min-h-screen flex font-['Outfit'] bg-[#FFF8F0]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#4A2C17] via-[#6B3E26] to-[#4A2C17]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-12">
          ...
          <div
            className="text-[110px] mb-6 drop-shadow-2xl select-none"
            style={{ filter: "drop-shadow(0 8px 24px rgba(232,116,42,0.3))" }}
          >
            🐶
          </div>
          ...
          <p className="text-[#D4A574] text-lg font-medium max-w-sm leading-relaxed">
            Join thousands of families who found their perfect furry companion
            through Paw Heaven.
          </p>
          ...
          <div className="mt-10 flex gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                <span className="text-2xl font-extrabold text-[#F5923E]">
                  {s.count}
                </span>
                <span className="text-[#D4A574] text-xs font-semibold mt-0.5">
                  {s.label}
                </span>
              </div>
            ))}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-[440px]">
          ...
          {/* Heading */}
          <div className="mb-8">
            <h1 className="text-4xl font-extrabold text-[#4A2C17] mb-2">
              Welcome back!
            </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-bold text-[#6B3E26]">
                Email Address
              </label>
              <input
                type="email"
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                ...
                <button
                  type="button"
                  className="text-xs text-[#E8742A] font-semibold hover:underline focus:outline-none"
                >
                  Forgot password?
                </button>
              </div>
          ...
          <p className="text-center text-[#6B3E26] font-medium mt-8 text-sm">
            ...
            <Link
              href="/signup"
              className="text-[#E8742A] font-extrabold hover:underline"
            >
              Create an account
            </Link>
          </p>
          ...
          <p className="text-center text-[#B89070] text-xs mt-6 leading-relaxed">
            ...
            <span className="underline cursor-pointer hover:text-[#E8742A] transition-colors">
              Terms of Service
            </span>{" "}
            and{" "}
            <span className="underline cursor-pointer hover:text-[#E8742A] transition-colors">
